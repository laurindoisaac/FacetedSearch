// src/lib.rs
/*
 * Core library for FacetedSearch
 */
...
#[derive(Debug)]
pub struct FacetedSearchProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FacetedSearchProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FacetedSearch processing");
    
    let mut processor = FacetedSearchProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FacetedSearchProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FacetedSearchProcessor::new(false);
